            ...
            <div className="relative z-0">
              <p className="text-xl">
                <em className="relative">
                  ...
                  <TextGenerateEffect className="relative z-10 adaptive-text text-2xl font-bold" duration={0.2} words={"WALNUT isn't a PC application; WALNUT is your PC in the browser, where you can run anything without worrying about resources."} />
                </em>
              </p>
            </div>
