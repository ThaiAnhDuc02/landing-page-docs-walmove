...
export default function ShowcaseSection() {
  ...
  const rotateY = useTransform(scrollYProgress, [0, 0.4, 0.5, 1], [60, 0, 0, -60]);
        ...
        <div className="max-w-4xl mx-auto" style={{ perspective: 2000 }}>
          ...
          >
            ...
            <div className="relative" style={{ transform: 'translateZ(10px)' }}>
              ...
              />
              {/* <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-1/5 bg-gradient-to-b from-transparent via-white to-white dark:via-black dark:to-black"></div> */}
            </div>
          </motion.div>
        </div>
            ...
            <div className="relative z-10">
              <p className="text-xl text-gray-800">
                <em className="relative">
                  ...
                  <span className="relative z-10 dark:text-white text-2xl font-bold">WALNET isn't a PC application; WALNET is your PC in the browser, where you can run anything without worrying about resources.</span>
                </em>
              </p>
            </div>
            <footer className="mt-6">
              <div className="text-base font-semibold text-gray-800 dark:text-neutral-400">Harry - Founder of <a href="https://www.walnet.io" target="_blank" className="text-blue-500">Walnet</a></div>
            </footer>
          </blockquote>
        </div>
      </div>
