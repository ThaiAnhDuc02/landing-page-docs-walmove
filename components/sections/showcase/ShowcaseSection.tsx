            ...
            >
              ...
              <div className="relative" style={{ transform: 'translateZ(10px)' }}>
                <Safari
                  ...
                  src={theme === "dark" ? "assets/about/how_to_work/blank1.png" : "/assets/about/how_to_work/blank1.png"}
                />
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative z-0">
              <p className="text-xl">
                <em className="relative">
                  ...
                  <TextGenerateEffect className="relative z-10 adaptive-text text-2xl font-bold" duration={0.2} words={"WALNET isn't a PC application; WALNET is your PC in the browser, where you can run anything without worrying about resources."} />
                </em>
              </p>
            </div>
            <BlurFade delay={0.5} inView>
              <footer className="mt-6 relative z-10">
                <div className="text-base font-semibold adaptive-text">Harry - Founder of
                  <LinkPreview isStatic url="https://walnet-deploy.vercel.app/" imageSrc={theme === "dark" ? '/assets/about/how_to_work/blank1.png' : '/assets/about/how_to_work/blank1.png'}>
                    {" "}
